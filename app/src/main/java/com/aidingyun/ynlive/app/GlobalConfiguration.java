...
import com.aidingyun.ynlive.app.utils.ParamInterceptor;
import com.aidingyun.ynlive.component.converter.CheckGsonConverterFactory;
...
public final class GlobalConfiguration implements ConfigModule {
    ...
    public void applyOptions(Context context, GlobalConfigModule.Builder builder) {
        if (!BuildConfig.LOG_DEBUG) { //Release 时,让框架不再打印  请求和响应的信息
        ...
        builder.baseurl(Api.APP_DOMAIN)
                ...
                .okhttpConfiguration((context1, okhttpBuilder) -> {//这里可以自己自定义配置Okhttp的参数
                    ...
                    okhttpBuilder.addInterceptor(new ParamInterceptor());
