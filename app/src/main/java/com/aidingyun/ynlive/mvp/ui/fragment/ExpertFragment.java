...
import com.aidingyun.ynlive.di.component.DaggerExpertComponent;
import com.aidingyun.ynlive.di.module.ExpertModule;
import com.aidingyun.ynlive.mvp.contract.ExpertContract;
import com.aidingyun.ynlive.mvp.presenter.ExpertPresenter;
...
public class ExpertFragment extends BaseFragment<ExpertPresenter> implements ExpertContract.View ,IndexRefresh {
    ...
    public void setupFragmentComponent(@NonNull AppComponent appComponent) {
        DaggerExpertComponent //如找不到该类,请编译一下项目
                .builder()
                .appComponent(appComponent)
                .expertModule(new ExpertModule(this))
                .build()
                .inject(this);
    }
