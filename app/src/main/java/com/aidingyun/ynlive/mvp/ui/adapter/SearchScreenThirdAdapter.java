 ...
 */
public class SearchScreenThirdAdapter extends BaseAdapter {

    private Context context;
    private int selectItem = 0;
    private List<CourseClassificationModel.DataBean.TypeDataBeanX.TypeDataBean> list;

    public SearchScreenThirdAdapter(Context context, List<CourseClassificationModel.DataBean.TypeDataBeanX.TypeDataBean> list) {
        this.list = list;
