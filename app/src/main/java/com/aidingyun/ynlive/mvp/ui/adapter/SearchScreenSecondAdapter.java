 ...
 */
public class SearchScreenSecondAdapter extends BaseAdapter {

    private Context context;
    private int selectItem = 0;
    private List<CourseClassificationModel.DataBean.TypeDataBeanX> list;

    public SearchScreenSecondAdapter(Context context, List<CourseClassificationModel.DataBean.TypeDataBeanX> list) {
        this.list = list;
