...
public class HasPaymentFragment extends Fragment {
    ...
    private List<CourseOrderInfo.DataBean.ListBean> listBeans;//接口数据
    ...
    RelativeLayout network_fail;
    SmartRefreshLayout refreshLayout;
    public static HasPaymentFragment newInstance() {
//        Bundle args = new Bundle();
//        args.putString("isLoad", isLoad);
        HasPaymentFragment fragment = new HasPaymentFragment();
